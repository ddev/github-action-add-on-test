...
- Temporary fix: add `HOMEBREW_NO_SANDBOX_LINUX=1` to the action's environment variables to fix Homebrew ([PR #64](https://github.com/ddev/github-action-add-on-test/pull/64))
